...
//11
      ...
      // ==============================================================================
        ...
        static void fnameupcasesnamelowcase(){
        ...
        if (studentEmailAddress.contains("gumarao") && studentEmailAddress.contains("@students.national-u.edu.ph"))  {
            System.out.println("valid");
        ...
        static void ATM(){
            ...
            final int OneThousand = 1000, FiveHundred = 500, TwoHundred = 200, OneHundred = 100, Fifty = 50, Twenty = 20;
            int SumB, OneK, FiveH, TwoH, OneH, Fifth, Twentieth;
            int amount, Samount;
        ...
        OneK = Samount / OneThousand;
    
        Samount -= OneK * OneThousand;
    
        FiveH = Samount / FiveHundred;
    
        Samount -= FiveH * FiveHundred;
    
        TwoH = Samount / TwoHundred;
    
        Samount -= TwoH * TwoHundred;
    
        OneH = Samount / OneHundred;
    
        Samount -= OneH * OneHundred;
    
        Fifth = Samount / Fifty;
    
        Samount -= Fifth * Fifty;
    
        Twentieth = Samount / Twenty;
    
        Samount -= Twentieth * Twenty;
    
    
    
    
    System.out.println("ATM Amount :"+amount);
    System.out.println("1000's :"+ OneK);
    System.out.println("500's :"+ FiveH);
    System.out.println("200's :"+ TwoH);
    System.out.println("100's :"+ OneH);
    System.out.println("50's :"+ Fifth);
    System.out.println("20's :"+ Twentieth);
    SumB = OneK + FiveH + TwoH + OneH + Fifth + Twentieth;
    System.out.println("Total Bills :" + SumB );
    System.out.println("Remaining Balance: " + Samount);

public class App {
    ...
    for (int row = 0; row < 15; row++) {
        ...
        for (int column = 0; column < 15; column++) {
            ...
            if (row == 9 && column == 9 || row == 8 && column == 8 || row == 7 && column == 7 || row == 6 && column == 6 || row == 5 && column == 5 || row == 4 && column == 4 || row == 3 && column == 3 || row == 2 && column == 2 || row == 1 && column == 1) {
                System.out.print(array[row][column]);
            }
            else{
                System.out.print(" ");
    ...
    for (int row = 0; row < 15; row++) {
        ...
        for (int column = 0; column < 15; column++) {
            ...
            if (row == 10  && column == 7 || row == 9  && column == 8 || row == 8  && column == 9 || row == 7  && column == 10 || row == 6  && column == 11 || row == 5  && column == 12 || row == 4  && column == 13 || row == 3  && column == 14) {
                System.out.print(array[row][column]);
            }
            else{
                System.out.print(" ");
    ...
    for (int row = 0; row < 15; row++) {
        ...
        for (int column = 0; column < 15; column++) {
            ...
            if (row == 10  && column == 5 || row == 9  && column == 4 || row == 8  && column == 3 || row == 7  && column == 2 || row == 6  && column == 1 || row == 5  && column == 0) {
                System.out.print(array[row][column]);
            }
            else{
                System.out.print(" ");
    ...
    for (int row = 0; row < 15; row++) {
        ...
        for (int column = 0; column < 15; column++) {
            ...
            if (row == 0  && column == 9 || row == 1  && column == 8 || row == 2  && column == 7 || row == 3  && column == 6 || row == 4  && column == 5 || row == 5  && column == 4) {
    ...
    for (int row = 0; row < 15; row++) {
        ...
        for (int column = 0; column < 15; column++) {
            ...
            if (row == 6  && column == 0 || row == 7  && column == 1 || row == 8  && column == 2 || row == 9  && column == 3 || row == 10  && column == 4) {
